...
`r shiny::icon("newspaper")` [Derek Wright, Sandesh Neupane, Jakob Butler, Raul Martinez, Jim Weller, Kirstin E Bett (2020) **Focusing the GWAS Lens on days to flower using latent variable phenotypes derived from global multi-environment trials **](https://github.com/derekmichaelwright/AGILE_LDP_GWAS_Phenology) 
...
# Save
ggsave("Figure_01.jpg", mp, width = 12, height = 7)
```
...
gg_gwas_summary <- function(traits, labels = traits,
  ...
  # Save
  ggsave(paste0(filename, ".jpg"), mp, width = width, height = height)
  # Save HTML
...
<iframe
  src="Additional/Additional_Figure_01_plotly.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
<iframe
  src="Additional/Additional_Figure_02_plotly.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
mp <- ggarrange(mp1, mp2, mp3, ncol = 3, widths = c(2,7,1.5), align = "h", 
                legend.grob = mpl, legend = "bottom", common.legend = T)
# Save
ggsave("Figure_03.jpg", mp, width = 12, height = 10)
```
...
for(i in expttraits) {
  ...
  # Save
  ggsave(paste0("Additional/CV/CV_", i, ".jpg"), mp, width = 12, height = 6)
}
```
...
# Save
ggsave("Figure_05.jpg", mp, width = 8, height = 8)
ggsave("Additional/Figure_05_a.jpg", mp1, width = 8, height = 4)
ggsave("Additional/Figure_05_b.jpg", mp2, width = 8, height = 4)
ggsave("Additional/Figure_05_c.jpg", mp3, width = 8, height = 4)
# Plot chr 2 + 5 markers
mp1 <- ggplotly(mp1)
...
<iframe
  src="Supplemental_Figure_01_plotly.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
<iframe
  src="Additional/Additional_Figure_03_plotly.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
<iframe
  src="Additional/Additional_Figure_04_plotly.html"
  style="width:100%; height:400px;"
  data-external="1"
></iframe>
...
# Save
ggsave("Supplemental_Figure_02.jpg", mp, width = 5, height = 10)
```
...
*Supplemental Figure 3: Regional genome-wide association results from 300 Mbp to 315 Mbp on chromosome 6 for selected traits with a lentil diversity panel using MLM, MLMM, FarmCPU and Blink models. Traits include days from sowing to flower (DTF) in Marchouch, Morocco 2016 (Mo16), thermal sum required for flowering (Tf) in Sutherland, Canada 2017 (Su17) and Metaponto, Italy 2017 (It17), nominal base temperature (Tb) in Su17 and It17, and the third principal component (PC3) from a principal component analysis of an analysis of 18 site-years of DTF data (Wright et al., 2020). Vertical lines represent the locations of selected flowering time genes within the associated QTL.*
...
mp <- ggplot() +
  ...
  labs(y = "-log<sub>10</sub>(*p*)", x = "Mbp")
# Save
ggsave("Supplemental_Figure_03.jpg", mp, width = 5, height = 10)
```
...
# Save
ggsave(paste0("Supplemental_Figure_04.jpg"), mp , width = 12, height = 8)
```
...
```{r echo = F}
downloadthis::download_link(
  link = "https://derekmichaelwright.github.io/AGILE_LDP_GWAS_Phenology/Supplemental_Figure_06.html",
  button_label = "Supplemental_Figure_06.html",
  button_type = "success",
  has_icon = TRUE,
  icon = "fas fa-chart-bar",
  self_contained = FALSE
...
<iframe
  src="Supplemental_Figure_06.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
# Save
ggsave("Supplemental_Figure_06.jpg", mp, width = 8, height = 3)
# Plotly
mp <- plot_ly(pca, x = ~PC1, y = ~PC2, z = ~PC3, 
  ...
  add_markers()
# Save
saveWidget(as_widget(mp), "Supplemental_Figure_06.html")
```
...
mp <- ggplot(xx, aes(x = Value)) + 
  ...
  theme_AGL
# Save
ggsave("Additional/Additional_Figure_05.jpg", mp, width = 14, height = 7)
```
