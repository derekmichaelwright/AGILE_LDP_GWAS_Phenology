...
mp <- ggplot() +
  ...
  labs(y = "-log<sub>10</sub>(*p*)", x = "Mbp")
# Save
ggsave("Supplemental_Figure_04.jpg", mp, width = 5, height = 10)
```
...
# Save
ggsave(paste0("Supplemental_Figure_05.jpg"), mp , width = 12, height = 8)
```
...
# Save
ggsave("Supplemental_Figure_07.jpg", mp, width = 8, height = 3)
# Plotly
...
mp <- ggplot(xx, aes(x = Value)) + 
  ...
  theme_AGL
# Save
ggsave("Additional/Additional_Figure_06.jpg", mp, width = 14, height = 7)
```
