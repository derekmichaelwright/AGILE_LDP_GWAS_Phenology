...
# Save
ggsave("Figure_01.png", mp, width = 12, height = 7)
```
...
![](Additional/Figure_03_1.png)

![](Additional/Figure_03_2.png)

![](Additional/Figure_03_3.png)
...
![](Supplemental_Figure_02.png){width=70%}
...
![](Supplemental_Figure_03.png){width=70%}
...
# Save
ggsave("Supplemental_Figure_06.png", mp, width = 8, height = 3)
# Plotly
...
mp <- ggplot(xx, aes(x = Value)) + 
  ...
  theme_AGL
# Save
ggsave("Additional/Additional_Figure_05.png", mp, width = 14, height = 7)
```
